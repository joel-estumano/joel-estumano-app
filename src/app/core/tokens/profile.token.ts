...
const profile: IProfileData = {
	...
	professionEmphasis: 'Especializado em soluções digitais para web, aplicativos móveis e consultoria técnica.',
	...
	projects: [
		...
		},
		{
			...
			name: 'ATS Globe',
			resources: ['TypeScript', 'Angular', 'SCSS', 'Bulma CSS', 'Java', 'Spring Boot', 'JavaScript', 'CSS'],
			bannerUrl: 'ct.png',
		...
		},
		{
			...
			name: 'Jogueiros',
			resources: ['JavaScript', 'Ionic', 'Angular', 'Bootstrap'],
